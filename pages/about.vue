<template>
  <div
    id="about-img"
    ref="about-img"
    class="bg-gray-100 h-screen w-1/2 absolute"
    data-flip-id="img-about"
  >
    <div
      class="p-3 text-white flex items-center justify-between border-b border--white"
    >
      <nuxt-link to="/" class="text-white">Back</nuxt-link>
      <h1 class="font-bold">Header</h1>
    </div>
    <svg
      id="svg-target"
      ref="svg-target"
      class="full-size svg-target"
